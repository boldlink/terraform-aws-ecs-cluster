...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster_vpc"></a> [cluster\_vpc](#module\_cluster\_vpc) | boldlink/vpc/aws | 3.0.4 |
...
| <a name="input_name"></a> [name](#input\_name) | Input the name of stack | `string` | `"terraform-aws-ecs-cluster"` | no |
